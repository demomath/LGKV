...
public class LGSerializer implements Serializer {
  ...
  public LGSerializer(LogInterceptor logInterceptor) {
    this.logInterceptor = logInterceptor;
  }

  @Override public <T> String serialize(String cipherText, T originalGivenValue) {
    LGUtils.checkNullOrEmpty("Cipher text", cipherText);
    LGUtils.checkNull("Value", originalGivenValue);
